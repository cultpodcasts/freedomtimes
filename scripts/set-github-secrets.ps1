...
$secrets = [ordered]@{
    ...
    AUTH0_STAGING_APP_CLIENT_ID        = Get-EnvValue -Values $env -Keys @("AUTH0_STAGING_APP_CLIENT_ID", "AUTH0_APP_CLIENT_ID_STAGING")
    ...
    AUTH0_PRODUCTION_APP_CLIENT_ID     = Get-EnvValue -Values $env -Keys @("AUTH0_PRODUCTION_APP_CLIENT_ID", "AUTH0_APP_CLIENT_ID_PRODUCTION")
