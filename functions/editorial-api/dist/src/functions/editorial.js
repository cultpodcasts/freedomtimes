...
functions_1.app.http('editorialHealth', {
    route: 'health',
    methods: ['GET'],
    authLevel: 'anonymous',
...
functions_1.app.http('editorialStoriesList', {
    route: 'stories',
    methods: ['GET'],
    authLevel: 'anonymous',
    handler: async (request, context) => {
...
functions_1.app.http('editorialStoryById', {
    route: 'stories/{id}',
    methods: ['GET'],
    authLevel: 'anonymous',
    handler: async (request, context) => {
...
functions_1.app.http('editorialStoriesSearch', {
